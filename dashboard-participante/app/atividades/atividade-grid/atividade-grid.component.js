...
var AtividadeGridComponent = (function () {
    ...
    AtividadeGridComponent.prototype.getQtdFavoritas = function () {
        return 15;
    ...
    AtividadeGridComponent.prototype.toggleVisibilityFavoritas = function () {
        if (this.selectedVisible != "Favoritas")
            this.selectedVisible = "Favoritas";
        else
            this.selectedVisible = "none";
    };
