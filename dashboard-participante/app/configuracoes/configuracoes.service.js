...
var ConfiguracoesService = (function () {
    function ConfiguracoesService(http) {
        this.http = http;
        this.configuracoesUrl = 'api/configuracoes';
        this.headers = new http_1.Headers({ 'Content-Type': 'application/json' });
    }
    ConfiguracoesService.prototype.getConfiguracoes = function () {
        return this.http.get(this.configuracoesUrl)
            .toPromise()
            .then(function (response) { return response.json().data; })
            .catch(this.handleError);
    };
    ConfiguracoesService.prototype.handleError = function (error) {
