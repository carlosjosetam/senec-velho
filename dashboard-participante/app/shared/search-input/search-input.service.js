...
var SearchInputService = (function () {
    function SearchInputService() {
        this.searchTermSource = new BehaviorSubject_1.BehaviorSubject("");
        this.searchTerm$ = this.searchTermSource.asObservable();
    }
    SearchInputService.prototype.updateTerm = function (newTerm) {
...
//# sourceMappingURL=search-input.service.js.map