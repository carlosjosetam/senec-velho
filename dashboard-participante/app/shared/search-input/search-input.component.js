...
var search_input_service_1 = require("./search-input.service");
var platform_browser_1 = require("@angular/platform-browser");
var SearchInputComponent = (function () {
    function SearchInputComponent(searchService, sanitizer) {
    ...
    SearchInputComponent.prototype.ngOnInit = function () {
        var numericWidth = Number(this.width.substring(0, this.width.length - 2)) - 84;
        this.safeWidth = this.sanitizer.bypassSecurityTrustStyle(numericWidth + "px");
    };
    SearchInputComponent.prototype.ngAfterViewChecked = function () {
        if (this.el && !this.focused) {
            this.el.nativeElement.focus();
            this.focused = true;
        }
    };
    SearchInputComponent.prototype.searchUpdate = function (newValue) {
        this.searchService.updateTerm(newValue);
    };
    SearchInputComponent.prototype.toggleSearchInput = function (value) {
        this.search = value;
